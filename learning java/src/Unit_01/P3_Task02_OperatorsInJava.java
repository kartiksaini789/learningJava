...
class OperatorsInJava {
	...
	void UnaryOperator() {
		...
		/*
		 * Bitwise compliment(~)
		 * This unary operator returns one's compliment representation of the input value
		 * With all bits inverted which means it takes every ones to zero and zero to one
		 */
